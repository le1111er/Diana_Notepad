...
public class NotesListAdapter extends BaseAdapter {
    ...
    private List<NoteBean> searchData;//被搜索到的数据
    ...
    public void readDate() {
        ...
        while(cursor.moveToNext())
        {
            ...
            Log.d("Database",cursor.getString(COLUMN_INDEX_TITLE)+","+cursor.getString(COLUMN_INDEX_MODIFICATION_DATE)+","+cursor.getString(COLUMN_INDEX_ID));
        }
    }
